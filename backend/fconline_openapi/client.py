...
class NexonFconlineClient:
    ...
    def get_user_maxdivision(self, ouid: str) -> Any:
        return self._get("/fconline/v1/user/maxdivision", params={"ouid": ouid})
    ...
    def get_meta_division(self) -> Any:
        return self._get("/static/fconline/meta/division.json")
