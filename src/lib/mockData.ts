...
export function formatSeasonLabel(id: SeasonId): string {
  const match = /^(\d{4})-(\d+)$/.exec(id);
  if (!match) return id;
  return `${match[1]} 시즌 ${Number(match[2])}`;
}
...
export const SEASONS: SeasonConfig[] = [
  { id: "2026-4", label: "2026 시즌 4", phase: "Season 4", active: true },
  { id: "2026-3", label: "2026 시즌 3", phase: "Season 3" },
  { id: "2026-2", label: "2026 시즌 2", phase: "Season 2" },
  { id: "2026-1", label: "2026 시즌 1", phase: "Season 1" },
  { id: "2025-3", label: "2025 시즌 3", phase: "Season 3" },
  { id: "2025-2", label: "2025 시즌 2", phase: "Season 2" },
  { id: "2025-1", label: "2025 시즌 1", phase: "Season 1" },
  { id: "2024-13", label: "2024 시즌 13", phase: "Season 13" },
];
